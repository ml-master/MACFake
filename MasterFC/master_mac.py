...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default = '/home/amax/sunyishanProject/ECAL2021/formatted_data/declare/', help = 'Input data path', type = str)
    parser.add_argument('--dataset', type = str, default = 'Snopes', help = '[Snopes, Politifact]')
    parser.add_argument('--epochs', default = 200, help = 'Number of epochs to run', type = int)
    ...
    parser.add_argument('--log', default = "/home/amax/sunyishanProject/ECAL2021/logs/mac", type = str, help = 'folder for logs and saved models')
    ...
    parser.add_argument('--num_att_heads_for_words', type = int, default = 5, help = 'Nums att heads for words')
    parser.add_argument('--num_att_heads_for_evds', type = int, default = 2, help = 'Nums att heads for evidences')
